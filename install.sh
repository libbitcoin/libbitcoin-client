...
build_all()
{
    ...
    build_from_github pmienk libbitcoin-protocol refactor_types $PARALLEL "$@" $BITCOIN_PROTOCOL_OPTIONS
    build_from_travis pmienk libbitcoin-client refactor_types $PARALLEL "$@" $BITCOIN_CLIENT_OPTIONS
}
